# Creating a tuple
lunch_menu = ("Welcome Drink", "Veg Starter", "Non-Veg Starter",
...
# This will create a new tuple by combining the elements of existing sample_tuple and sample_tuple1
sample_tuple = sample_tuple+sample_tuple1
print(sample_tuple)

# Adding a single element to a tuple
# This will also create a new tuple, sample_tuple
...
# This line will result in an error, i.e., tuple is immutable
lunch_menu[0] = ""
print(lunch_menu)
